...
% 
% SOFiA Lebedev Grid R11-1220
% 
% Copyright (C)2011 by bBrn - benjamin Bernschütz 
%
% Core routines for Lebedev quadrature calculation:
% -----------------------------------------------------------
...
disp('SOFiA Lebedev Grid R11-1220');
...
[theta, phi, ~] = cart2sph(leb.x, leb.y, leb.z);
leb.w = leb.w/(4*pi); 
...
leb_tmp.x = zeros(degree,1);
leb_tmp.y = zeros(degree,1);
leb_tmp.z = zeros(degree,1);
leb_tmp.w = zeros(degree,1);
...
switch (degree)
    ...
    case 146
        ...
        [leb_tmp start] = getLebedevReccurencePoints(6,start,a,b,v,leb_tmp);
    ...
    otherwise
        error('Angular grid unrecognized, choices are 6, 14, 26, 38, 50, 74, 86, 110, 146, 170, 194, 230, 266, 302, 350, 434, 590, 770, 974, 1202, 1454, 1730, 2030, 2354, 2702, 3074, 3470, 3890, 4334, 4802, 5294, 5810');

end
leb_tmp.n = degree;
end
function [leb start] = getLebedevReccurencePoints(type, start, a, b, v, leb)
